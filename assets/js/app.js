        ...
        window.mediaLoaded = function (el) {
            ...
            const sk = el.previousElementSibling || el.closest('.row-media')?.querySelector('.loader-overlay');
